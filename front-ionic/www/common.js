"use strict";
(self["webpackChunkfront_ionic"] = self["webpackChunkfront_ionic"] || []).push([[2076],{

/***/ 149:
/*!*********************************************!*\
  !*** ./src/app/services/elderly.service.ts ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ElderlyService: () => (/* binding */ ElderlyService)
/* harmony export */ });
...
let ElderlyService = /*#__PURE__*/(() => {
  class ElderlyService {
    ...
    registerElderly(elderlyData) {
      ...
      const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.b({
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
      });
      return this.http.post(`${this.apiUrl}/elderly/signup`, elderlyData, {
        headers
    ...
    getElderlies() {
      ...
      if (!token) {
        ...
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.throwError)(() => new Error('Não autenticado'));
      }
      ...
      return this.http.get(`${this.apiUrl}/elderly`, {
        headers
      }).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.tap)(response => {
    ...
    getElderly(id) {
      ...
      return this.http.get(`${this.apiUrl}/elderly/${id}`, {
        headers
      }).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.tap)(response => {
    ...
    updateElderly(id, elderlyData) {
      const token = this.authService.getToken();
      const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.b({
        'Content-Type': 'application/json',
        'Authorization': `Bearer ${token}`
      });
      return this.http.put(`${this.apiUrl}/elderly/${id}`, elderlyData, {
        headers
      });
    }
    // Remover um idoso
    deleteElderly(id) {
      ...
      return this.http.delete(`${this.apiUrl}/elderly/${id}`, {
        headers
      });
    }
    ...
    validatePin(pin) {
      ...
      return this.http.post(`${this.apiUrl}/elderly/login`, {
        pin
      }, {
        headers
      }).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.tap)(response => {
        console.log('Resposta do login PIN:', response);
      }), (0,rxjs__WEBPACK_IMPORTED_MODULE_3__.catchError)(error => {
        console.error('Erro detalhado no login PIN:', error);
        console.error('Status:', error.status);
        console.error('URL:', error.url);
        console.error('Mensagem:', error.message);
        return (0,rxjs__WEBPACK_IMPORTED_MODULE_4__.throwError)(() => error);
    ...
    static ɵfac = function ElderlyService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || ElderlyService)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.a), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_auth_service__WEBPACK_IMPORTED_MODULE_0__.AuthService));
    };
    static ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjectable"]({
      token: ElderlyService,
      factory: ElderlyService.ɵfac,
      providedIn: 'root'
    });
  }
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_davif_completoCare_front_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
...
/***/ 3751:
/*!********************************************************!*\
  !*** ./src/app/services/elderly-medication.service.ts ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ElderlyMedicationService: () => (/* binding */ ElderlyMedicationService)
/* harmony export */ });
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ 8326);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ 8764);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ 1318);
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! rxjs */ 7919);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/core */ 7580);
/* harmony import */ var _elderly_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./elderly.service */ 149);





let ElderlyMedicationService = /*#__PURE__*/(() => {
  class ElderlyMedicationService {
    http;
    elderlyService;
    apiUrl = 'http://localhost:3000';
    constructor(http, elderlyService) {
      this.http = http;
    ...
    getMyMedications() {
      ...
      return this.http.get(`${this.apiUrl}/elderly/medications/my-medications`, {
    ...
    getActiveMedications() {
      ...
      return this.http.get(`${this.apiUrl}/elderly/medications/active`, {
        headers: this.getHeaders()
      }).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.tap)(response => {
    ...
    getTodaySchedule() {
      ...
      return this.http.get(`${this.apiUrl}/elderly/medications/today-schedule`, {
        headers: this.getHeaders()
      }).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.tap)(response => {
    ...
    getSummary() {
      ...
      return this.http.get(`${this.apiUrl}/elderly/medications/summary`, {
        headers: this.getHeaders()
      }).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.tap)(response => {
    ...
    getDashboard() {
      ...
      return this.http.get(`${this.apiUrl}/elderly/medications/dashboard`, {
        headers: this.getHeaders()
      }).pipe((0,rxjs__WEBPACK_IMPORTED_MODULE_2__.tap)(response => {
    ...
    static ɵfac = function ElderlyMedicationService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || ElderlyMedicationService)(_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__.a), _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵinject"](_elderly_service__WEBPACK_IMPORTED_MODULE_0__.ElderlyService));
    };
    static ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjectable"]({
      token: ElderlyMedicationService,
      factory: ElderlyMedicationService.ɵfac,
      providedIn: 'root'
    });
  }
  return ElderlyMedicationService;
})();
...
const createKeyboardController = /*#__PURE__*/function () {
  var _ref = (0,C_Users_davif_completoCare_front_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardChangeCallback) {
    ...
    const init = /*#__PURE__*/function () {
      var _ref2 = (0,C_Users_davif_completoCare_front_ionic_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
